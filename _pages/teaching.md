...
<div class = "col one last">
 <div style="float:right; padding: 10px; width: 50%; height: 50%">
    ...
    <figcaption>Designing a lab assignment for OCEAN 320 students to work with a scale model of Puget Sound (I'm on the left)</center></figcaption>
 </div>
</div>
</figure>
...
<div class = "col one last">
  <div style="float:left; padding: 10px; width: 50%; height: 50%">
        <center><img src="{{ site.baseurl }}/assets/img/IMG-20190816-WA0002.jpg" style="width: 70%; height: 70%">
    <figcaption>Casting a CTD off a small boat in the San Juan Islands for OCEAN 529 (I'm on right)</center></figcaption>
 </div>
</div>
</figure>
