...
<img class="col one last" src="{{ site.baseurl }}/assets/img/ptracks_base_smallgrid_shifted_labels.png" style="float:right; width: 25%; height: 25%">
...
<img src="{{ site.baseurl }}/assets/img/IMG_1558b.jpg" style="float:right; width: 100%; height: 100%">
</div>
